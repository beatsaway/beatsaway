...
class Clap {
    ...
    static parameterNames = {
        spacing: { min: 0.01, max: 0.1, default: 0.03, label: 'Spacing' },
        decay: { min: 0.1, max: 2, default: 0.5, label: 'Decay' },
        reverbDecay: { min: 0.1, max: 2, default: 0.7, label: 'Reverb Decay' },
        filterFreq: { min: 100, max: 2000, default: 1000, label: 'Filter Frequency' },
        filterQ: { min: 0.1, max: 10, default: 1, label: 'Filter Q' },
